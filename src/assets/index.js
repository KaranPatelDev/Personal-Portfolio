...
const mediapipe =
  "https://mediapipe.dev/images/mediapipe_small.png";
const fastapi =
...
export {
    ...
    docker, falverra, fastapi, figma, freelance, git, github, html,
    javascript, logo, macbookpro, matplotlib, mediapipe, menu, meta, mobile, mongodb,
    nodejs, numpy,
    opencv, pandas, postman, python,
    reactjs,
    redux, seaborn, sheryians, shopify, sql, tailwind, threejs, tripguide, typescript, web
};
